...
export function NewAgent() {
  ...
  useEffect(() => {
    if (isFirstAgent) {
      if (!name) setName("Principal Investigator");
      if (!title) setTitle("Principal Investigator");
    }
    ...
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      <div className="border border-border">
              ...
              >
                {currentReportsTo ? (
                  ...
                  <>
                    ...
                    {isFirstAgent ? "Reports to: N/A (Principal Investigator)" : "Reports to..."}
                  </>
                )}
              </button>
            </PopoverTrigger>
        ...
        <div className="border-t border-border px-4 py-3">
          {isFirstAgent && (
            <p className="text-xs text-muted-foreground mb-2">This will be the Principal Investigator</p>
          )}
          {formError && (
